...
| STATS  | unsloth/gemma-4-E4B-it | unsloth/Phi-4 | unsloth/Qwen3.5-9B |
|--------|------------------------|---------------|--------------------|
|  min   |  12                    |      34       |  19                |
|  50p   |  33                    |      95       |  48                |
|  75p   |  35                    |      101      |  51                |
...
| unsloth/gemma-4-E4B-it  |UNTRAINED | DEV → DEV + 0-shot        |greedy  |0.00     |8.25       |8.25          |**77.78**   |anustubh_poetry_gemma4-8B_untrained_0shot    |
| unsloth/gemma-4-E4B-it  |Finetuned | DEV → DEV + 0-shot        |sampling|0.73     |34.35      |33.62         |72.26       |anustubh_poetry_gemma4-8B_DEV_sampling_0shot |
...
| unsloth/Qwen3.5-9B      |Finetuned | DEV → DEV + 0-shot        |greedy  |17.78    |66.32      |48.54         |74.20       |anustubh_poetry_qwen3d5-9B_DEV_greedy_0shot  |
| unsloth/Qwen3.5-9B      |Finetuned | DEV → DEV + 3-shot        |Sampling|17.2     |64.74      |47.51         |72.86       |anustubh_poetry_qwen3d5-9B_DEV_sampling_3shot|
| unsloth/Qwen3.5-9B      |Finetuned | DEV → DEV + 3-shot        |Sampling|13.29    |61.28      |48.00         |72.79       |anustubh_poetry_qwen3d5-9B_DEV_sampling_6shot|
**BOLD**: MAX
*ITALIC*: Second Max
### Notes
